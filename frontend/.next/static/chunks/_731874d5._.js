...
function QuestionsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "QuestionsPage.useEffect": ()=>{
            // If the initial auth check is done and the user is not authenticated, redirect them.
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        ...
        isAuthenticated
    ]); // Re-fetch only when authentication status changes
    // --- Render Logic ---
    // Show a full-screen loader while checking authentication
    if (isAuthLoading) {
    ...
    // After the check, if the user is not authenticated, render nothing (will be redirected).
    if (!isAuthenticated) {
        return null;
    }
    const handleLogout = ()=>{
...
_s(QuestionsPage, "6/m529oIi1BGdfCMqIfajRDjZ+I=", false, function() {
    return [
...
//# sourceMappingURL=_731874d5._.js.map