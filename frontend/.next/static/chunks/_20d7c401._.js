            ...
            const fetchTotalQuestions = {
                "DashboardPage.useEffect.fetchTotalQuestions": async ()=>{
                    ...
                    try {
                        ...
                        if (!(result === null || result === void 0 ? void 0 : result.data)) throw new Error('Invalid API response');
                        let total = 0;
...
_s(DashboardPage, "NVsvxhGYDRmCUg1Leci9ldu4bWg=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
...
//# sourceMappingURL=_20d7c401._.js.map