...
const AuthProvider = ({ children })=>{
    ...
    const login = (userData, token)=>{
        // When a user logs in, save their data to state and localStorage
        setUser(userData);
        setToken(token);
    ...
    const logout = ()=>{
        // When a user logs out, clear their data from state and localStorage
        setUser(null);
        setToken(null);
        localStorage.removeItem('user');
        localStorage.removeItem('token');
    // The redirection to the home/login screen will be handled by the
    // component that calls this logout function (e.g., the header or questions page).
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__defe57a3._.js.map